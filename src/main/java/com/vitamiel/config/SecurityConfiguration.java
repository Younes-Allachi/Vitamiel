...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(Environment env, JHipsterProperties jHipsterProperties,MongoUserDetailsService mongoUserDetailsService) {
        this.env = env;
            ...
            .authorizeHttpRequests(authz -> 
                authz
                    ...
                    .requestMatchers(
                        ...
                        mvc.pattern("/*.bmp"),
                        mvc.pattern("/*.tiff")
                    ).permitAll()  // Allow all image formats
