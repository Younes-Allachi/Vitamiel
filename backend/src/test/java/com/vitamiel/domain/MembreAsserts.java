...
public class MembreAsserts {
    ...
    public static void assertMembreUpdatableFieldsEquals(Membre expected, Membre actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getLivraisonAdress()).as("check livraisonAdress").isEqualTo(actual.getLivraisonAdress()))
            .satisfies(e ->
                assertThat(e.getCommunicationPreference())
                    .as("check communicationPreference")
                    .isEqualTo(actual.getCommunicationPreference())
            );
    }
